...
// --- Central Voice Intelligence Driver Response Schema ---

@JsonClass(generateAdapter = true)
data class VoiceIntelligenceResult(
    @Json(name = "intent") val intent: String, // "navigate_ev_charger" | "navigate_general" | "unsupported"
